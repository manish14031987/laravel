                                    ...
                                    <div class="tab-pane active" id="inquiry-desc" role="tabpanel">
                                        ...
                                        <div class="tab-block">
                                            <div class="form-group row">
                                                {!!Form::textarea('salesorder_description',isset($sales_order->salesorder_description) ? $sales_order->salesorder_description : '',array('class'=>'form-control header_note  border-radius-0 no-resize','placeholder'=>'Please enter sales order detailed description','maxlength'=>255))!!}
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            <div class="form-input-icon">
                                                                {!!Form::text('salesorder_number',$sales_order->salesorder_number,array('class'=>'form-control border-radius-0','readonly'))!!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            <div class="form-input-icon">
                                                                {!!Form::select('customer',$customer_id,isset($sales_order->customer) ? $sales_order->customer : '',array('class'=>'form-control border-radius-0 select2 customer','placeholder'=>'Please select customer','id'=>'customer'))!!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::select('sales_organization',$salesorg,isset($sales_order->sales_organization) ? $sales_order->sales_organization : '',array('class'=>'form-control border-radius-0 select2','placeholder'=>'Please select sales organization','id'=>'sales_organization'))!!}  
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Inquiry Number*:</label>
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::select('inquiry',$inquiry_no,isset($sales_order->inquiry) ? $sales_order->inquiry : '',array('class'=>'form-control border-radius-0 select2','placeholder'=>'Please select inquiry number','id'=>'inquiry_no'))!!}  
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Requested By:</label>
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::select('requested_by',$requestedby,isset($sales_order->requested_by) ? $sales_order->requested_by : '',array('class'=>'form-control border-radius-0 select2','placeholder'=>'Please select requested by','id'=>'requested_by'))!!}  
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            <div class="form-input-icon">
                                                                {!!Form::text('customer_name',isset($sales_order->customer_name) ? $sales_order->customer_name : '',array('class'=>'form-control border-radius-0','placeholder'=>'Customer name','readonly'))!!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::select('sales_region',$salesregion,isset($sales_order->sales_region) ? $sales_order->sales_region : '',array('class'=>'form-control border-radius-0 select2','placeholder'=>'Please select sales region','id'=>'sales_region'))!!}  
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Quotation Number*:</label>
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::select('quotation',$quotation_no,isset($sales_order->quotation) ? $sales_order->quotation : '',array('class'=>'form-control border-radius-0 select2','placeholder'=>'Please select quotation number','id'=>'quotation_no'))!!}  
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Billing Type:</label>
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::select('billing_type',$billing_type,isset($sales_order->billing_type) ? $sales_order->billing_type : '',array('class'=>'form-control border-radius-0 select2','placeholder'=>'Please select billing type','id'=>'billing_type'))!!}  
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            <div class="form-input-icon">
                                                                {!!Form::text('salesorder_gross_price',isset($sales_order->salesorder_gross_price) ? $sales_order->salesorder_gross_price : '',array('class'=>'form-control border-radius-0','readonly','placeholder'=>'Gross Price'))!!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('salesorder_profit_amt',isset($sales_order->salesorder_profit_amt) ? $sales_order->salesorder_profit_amt : '',array('class'=>'form-control border-radius-0','placeholder'=>'Profit margin amount','readonly'))!!}  
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            <div class="form-input-icon">
                                                                {!!Form::text('salesorder_discount',isset($sales_order->salesorder_discount) ? $sales_order->salesorder_discount : '',array('class'=>'form-control border-radius-0','placeholder'=>'Discount','readonly'))!!}
                                                            </div>
                                                        </div>
                                                    </div> 
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('salesorder_discount_gross_price',isset($sales_order->salesorder_discount_gross_price) ? $sales_order->salesorder_discount_gross_price : '',array('class'=>'form-control border-radius-0','placeholder'=>'Discount gross price','readonly'))!!}  
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Net Price:</label>
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('salesorder_net_price',isset($sales_order->salesorder_net_price) ? $sales_order->salesorder_net_price : '',array('class'=>'form-control border-radius-0','placeholder'=>'Net price','readonly'))!!}  
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Total Price:</label>
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('salesorder_total_price',isset($sales_order->salesorder_total_price) ? $sales_order->salesorder_total_price : '',array('class'=>'form-control border-radius-0','placeholder'=>'Total price','readonly'))!!}  
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            <div class="form-input-icon">
                                                                {!!Form::text('salesorder_profit_margin',isset($sales_order->salesorder_profit_margin) ? $sales_order->salesorder_profit_margin : '',array('class'=>'form-control border-radius-0','placeholder'=>'Profit margin','readonly'))!!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                            ...
                            <tbody id='purchase_item_form'>
                                ...
                                <tr id="purchase_item_{{isset($loop->index)?$loop->index:''}}" class = "form">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="javascript:void(0)" onclick="{var res = confirm('Are you sure you want to delete this item ?');
                                                                            if (res == true){document.getElementById('delform{{$sales_item->id}}').submit();
                                                                                                                        settimeout(function(){$('table #sales_item{{$loop->index}}').remove(); }, 1000); }}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <!--Delete--> </a>
                                        {!! Form::close() !!}
                                    </td> 
                                    <td>                                        
                                    ...
                                    <td>
                                        {!!Form::text('item_no',isset($sales_item->item_no) ? $sales_item->item_no : 10,array('class'=>'form-control padding-input border-radius-0 width-70','min'=>0,'readonly'))!!}
                                    </td>
                                    <td>
                                        {!!Form::select('material',$material,isset($sales_item->material)? $sales_item->material:'',array('class'=>'form-control material select2 border-radius-0','placeholder'=>'Please select Material','id'=>'material'))!!}
                                    </td>
                                    <td>
                                        {!!Form::text('material_description',isset($sales_item->material_description)? $sales_item->material_description:'',array('class'=>'form-control border-radius-0 no-resize','placeholder'=>'Enter Description','maxlength'=>50))!!}
                                    </td>
                                    <td>
                                        {!!Form::text('customer_material_no',isset($sales_item->customer_material_no)? $sales_item->customer_material_no:'',array('class'=>'form-control border-radius-0','placeholder'=>'Please select customer material no.'))!!}
                                    </td>
                                    <td>
                                        {!!Form::text('order_qty',isset($sales_item->order_qty)? $sales_item->order_qty:'',array('class'=>'form-control border-radius-0 totalamt','placeholder'=>'Please enter Quantity','id'=>'order_qty'))!!}
                                    </td>
                                    <td>
                                        {!!Form::text('cost_unit',isset($sales_item->cost_unit)? $sales_item->cost_unit:'',array('class'=>'form-control border-radius-0 padding-input totalamt','placeholder'=>'Please enter cost per unit','id'=>'cost_unit'))!!}
                                    </td>
                                    <td>
                                        {!!Form::text('tota_amt',isset($sales_item->tota_amt)? $sales_item->tota_amt:'',array('class'=>'form-control  border-radius-0 padding-input','placeholder'=>'Please enter total amount','readonly'))!!}                                   
                                    </td>
                                    <td>
                                        {!!Form::select('material_group',['Raw Material'=>'Raw Material','Service Material'=>'Service Material'],isset($sales_item->material_group)? $sales_item->material_group:'',array('class'=>'form-control select2 border-radius-0','placeholder'=>'Please select Material Group'))!!}
                                    </td>
                                    <td>
                                        {!!Form::select('reason',$reasonRejection,isset($sales_item->reason) ? $sales_item->reason : '',array('class'=>'form-control select2  border-radius-0','placeholder'=>'Please select Reason for Rejection'))!!}
                                    </td>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('incoterms',isset($itemData->incoterms) ? $itemData->incoterms : '',array('class'=>'form-control border-radius-0','placeholder'=>'Please enter incoterms','id'=>'incoterms'))!!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('milestone',isset($itemData->milestone) ? $itemData->milestone : '',array('class'=>'form-control border-radius-0','placeholder'=>'Please enter milestone / month','id'=>'milestone'))!!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2">
                                                            <label>Yes {!!Form::checkbox('auto_billing','0',false,array('id'=>'auto_billing'))!!}</label>
                                                        </div>
                                                    </div>
                                                    @else
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Auto Billing:</label>
                                                        <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2">
                                                            <label>Yes {!!Form::checkbox('auto_billing','1',true,array('id'=>'auto_billing'))!!}</label>
                                                        </div>
                                                    </div>
                                                    @else
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('payment_card',isset($itemData->payment_card) ? $itemData->payment_card : '',array('class'=>'form-control border-radius-0','placeholder'=>'Please enter payment card details'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xs-12 col-sm-6 col-md-4 col-form-label p-l-3 line-n word-break wspace-n">Down Payment Amount / Item:</label>
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('down_payment',isset($itemData->down_payment) ? $itemData->down_payment : '',array('class'=>'form-control border-radius-0','placeholder'=>'Please enter down payment amount'))!!}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            <label class="input-group datepicker-only-init">
                                                                {!!Form::text('invoicing_dates',isset($itemData->invoicing_dates) ? $itemData->invoicing_dates : '',array('class'=>'form-control border-radius-0 datepicker-only-init','placeholder'=>'Please select invoicing date'))!!}
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('billing_block',isset($itemData->billing_block) ? $itemData->billing_block : '',array('class'=>'form-control border-radius-0','placeholder'=>'Please enter billing block'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('billing_reminder',isset($itemData->billing_reminder) ? $itemData->billing_reminder : '',array('class'=>'form-control border-radius-0','placeholder'=>'Please enter billing reminder notification'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">PayPal account details:</label>
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('paypal',isset($itemData->paypal) ? $itemData->paypal : '',array('class'=>'form-control border-radius-0','placeholder'=>'Please enter paypal account details'))!!}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('created_on',isset($sales_order->created_on) ? $sales_order->created_on : '',array('class'=>'form-control border-radius-0','readonly'))!!}  
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('changed_on',isset($sales_order->changed_on) ? $sales_order->changed_on : '',array('class'=>'form-control border-radius-0','readonly'))!!}  
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
...
<script type="text/javascript">
                                                                    ...
                                                                    var id = document.querySelectorAll('#purchase_item_form tr').length;
                                                                            ...
                                                                            /**
                                                                             * radio change event starts here
                                                                             */
